...
for LOGGING in WITH WITHOUT;
do

sed -i "91c #define ${LOGGING}_LATCH_LOGGING" include/common/common.h
...
do
        ...
        mv ../build/workload/micro/result_all_threads.txt ../edbt_results/micro_${LOGGING}_naive_log_${INDEX}
        mv ../build/workload/smallbank/result_all_threads.txt ../edbt_results/smallbank_${LOGGING}_naive_log_${INDEX}
        mv ../build/workload/tatp/result_all_threads.txt ../edbt_results/tatp_${LOGGING}_naive_log_${INDEX}
        mv ../build/workload/tpcc/result_all_threads.txt ../edbt_results/tpcc_${LOGGING}_naive_log_${INDEX}


done

bash average.sh ../edbt_results/micro_${LOGGING}_naive_log 5
bash average.sh ../edbt_results/smallbank_${LOGGING}_naive_log 5
bash average.sh ../edbt_results/tatp_${LOGGING}_naive_log 5
bash average.sh ../edbt_results/tpcc_${LOGGING}_naive_log 5
