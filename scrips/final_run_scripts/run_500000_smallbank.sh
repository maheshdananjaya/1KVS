...
mv result_all_threads.txt result_all_threads_10x8.txt



sed -i '5c "thread_num_per_machine": 12,' ../../../config/compute_node_config.json
sed -i '6c "coroutine_num": 9,' ../../../config/compute_node_config.json
parallel-ssh -i -H node-5 'bash startexp.sh'
parallel-ssh -i -H node-6 'bash startexp.sh'
sleep 10
...
mv result_all_threads.txt result_all_threads_12x8.txt
