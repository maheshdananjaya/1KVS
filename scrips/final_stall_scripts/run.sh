...
cp result_all_threads* ../../../bench_results/eurosys/micro_stall_1000/with_crash/
...
mv result_all_threads.txt result_all_threads_crash_enable_latchstall_128_4.txt
cp result_all_threads* ../../../bench_results/eurosys/micro_stall_1000/with_crash_norecovery/
...
mv result_all_threads.txt result_all_threads_crash_enable_latchstall_128_4.txt
cp result_all_threads* ../../../bench_results/eurosys/micro_stall_1000/with_crash_noresume/
